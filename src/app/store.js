...
const reducer = (state, action) => {
    switch (action.type) {
        ...
        case 'SET_OPTIONS':
            return {...state, isMini: action.options.height < 160, options: action.options};
        case 'UPDATE_OPTIONS':
            return {...state, isMini: action.options.height < 160, options: {...state.options, ...action.options}};
        case 'LIKE_TRACK':
